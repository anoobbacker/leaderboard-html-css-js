...
var resultsURL = "https://fabrikamsa1.blob.core.windows.net/wc2018/results.csv?ver=3.0";
    ...
    if (i == 0) {
      ...
      if (newMatch) {
        ...
        if (!"Complete".localeCompare(matchResultStatus)) {
          ...
          var matchDateDiff = Math.abs(Date.parse(matchResultStatus.slice(0,-8)) - new Date());
